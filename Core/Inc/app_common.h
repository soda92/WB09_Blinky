...
#define FRACTIONAL_1DIGIT(x)                                                   \
  (x > 0) ? ((int)(((x) - INT(x)) * 10)) : ((int)((INT(x) - (x)) * 10))

#define FRACTIONAL_2DIGITS(x)                                                  \
  (x > 0) ? ((int)(((x) - INT(x)) * 100)) : ((int)((INT(x) - (x)) * 100))

#define FRACTIONAL_3DIGITS(x)                                                  \
  (x > 0) ? ((int)(((x) - INT(x)) * 1000)) : ((int)((INT(x) - (x)) * 1000))
